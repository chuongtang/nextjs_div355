...
const loading = () => {
  return (
    ...
    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white opacity-20">Loading component</h5>
    <p className="font-normal text-gray-700 dark:text-gray-400 opacity-20">Please do not click refresh or back button</p>
